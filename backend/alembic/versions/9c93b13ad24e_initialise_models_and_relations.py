"""initialise models and relations

Revision ID: 9c93b13ad24e
Revises: 
Create Date: 2024-01-17 01:49:03.709324
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('DEPOSIT', 'WITHDRAWAL', 'TRANSFER_IN', 'TRANSFER_OUT', 'LOAN_TAKE', 'LOAN_PAYOFF', name='transactiontype'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['account_id'], ['accounts.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
